...
TRANSLATIONS = {
    'en': {
        ...
        'hero': {
            ...
            'h1a':      'Trusted',
            'h1b':      'IT & Cybersecurity',
            'h1c':      'Consulting for Norwegian Businesses',
            'sub':      'We help Norwegian companies protect their infrastructure, modernize their technology, and solve complex IT challenges — from security audits to full-scale cloud delivery.',
            'cta1':     'Book Consultation',
            'cta2':     'Explore Services',
        },
        'stats': [
            {'num': '20+', 'label': 'Projects delivered'},
            {'num': 'Oslo','label': 'Norway-based team'},
            {'num': '24h', 'label': 'Guaranteed response'},
        ],
        'services': {
            'label': 'What we do',
            'title': 'IT & cybersecurity consulting',
            'sub':   'Practical, results-driven consulting for Norwegian businesses — from security strategy to cloud delivery.',
            'list': [
                {'icon':'ti-shield-lock', 'name':'Cybersecurity Services', 'desc':'Penetration testing, zero-trust architecture, compliance audits, and cloud security hardening for regulated industries.'},
                {'icon':'ti-cloud',       'name':'Cloud & DevOps',         'desc':'AWS architecture, infrastructure as code, CI/CD pipelines, and cost-optimized cloud operations.'},
                {'icon':'ti-code',        'name':'Web Development',        'desc':'Custom web applications, REST APIs, and client portals — built secure-by-design, to your exact specification.'},
                {'icon':'ti-briefcase',   'name':'IT Consulting',          'desc':'Technology strategy, architecture reviews, vendor selection, and digital transformation roadmaps.'},
                {'icon':'ti-database',    'name':'Data Engineering',       'desc':'ETL pipelines, data warehouses, real-time dashboards, and BI solutions that drive better decisions.'},
            ],
        },
        'process': {
            'label': 'How we work',
        ...
        'contact': {
            ...
            'service_opts':['Cybersecurity Services','Cloud & DevOps','Web Development','IT Consulting','Data Engineering','Other'],
        },
        'footer': {
    ...
    'no': {
        ...
        'hero': {
            ...
            'h1a':      'Betrodd',
            'h1b':      'IT- og cybersikkerhetsrådgivning',
            'h1c':      'for norske bedrifter',
            'sub':      'Vi hjelper norske bedrifter med å beskytte infrastruktur, modernisere teknologi og løse komplekse IT-utfordringer — fra sikkerhetsrevisjoner til helhetlig skyleveranse.',
            'cta1':     'Book konsultasjon',
            'cta2':     'Utforsk tjenester',
        },
        'stats': [
            {'num': '20+', 'label': 'Leverte prosjekter'},
            {'num': 'Oslo','label': 'Norskbasert team'},
            {'num': '24t', 'label': 'Garantert respons'},
        ],
        'services': {
            'label': 'Hva vi gjør',
            'title': 'IT- og cybersikkerhetsrådgivning',
            'sub':   'Praktisk, resultatorientert rådgivning for norske bedrifter — fra sikkerhetsstrategi til skyleveranse.',
            'list': [
                {'icon':'ti-shield-lock', 'name':'Cybersikkerhet',     'desc':'Penetrasjonstesting, zero-trust-arkitektur, compliance-revisjoner og sky-sikkerhetsherdning for regulerte bransjer.'},
                {'icon':'ti-cloud',       'name':'Sky og DevOps',       'desc':'AWS-arkitektur, infrastruktur som kode, CI/CD-pipelines og kostnadsoptimaliserte skyoperasjoner.'},
                {'icon':'ti-code',        'name':'Webutvikling',        'desc':'Skreddersydde webapplikasjoner, REST-APIer og klientportaler — bygget sikre-fra-design, etter dine spesifikasjoner.'},
                {'icon':'ti-briefcase',   'name':'IT-rådgivning',       'desc':'Teknologistrategi, arkitekturgjennomganger, leverandørvalg og veikart for digital transformasjon.'},
                {'icon':'ti-database',    'name':'Dataingeniørarbeid',  'desc':'ETL-pipelines, datavarehus, sanntidsdashboards og BI-løsninger som driver bedre beslutninger.'},
            ],
        },
        'process': {
        ...
        'contact': {
            ...
            'service_opts':['Cybersikkerhet','Sky og DevOps','Webutvikling','IT-rådgivning','Dataingeniørarbeid','Annet'],
        },
        'footer': {
